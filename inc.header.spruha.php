			...
			<div class="main-container container-fluid">
				...
				<div class="main-header-center">
					<div class="responsive-logo">
						<a href="home<?php echo $ext?>"><img src="img/icon-sidebar.png" class="mobile-logo" alt="logo"></a>
						<a href="home<?php echo $ext?>"><img src="img/icon-sidebar.png" class="mobile-logo-dark"
								alt="logo"></a>
					</div>
